...
void main() {
  ...
  if (ba2 is BankAccount) {
    ...
    print('ba2 is not a BankAccount');
  }

  // switch-case
  switch (ba1.owner) {
    case 'Jeff':
      print('Jeff is the bank account owner'); // this it printed
      break;
    case 'Mary':
      print('Mary is ther bank account owner');
      break;
    default:
  ...
  while (rabbitCount <= 20000) {
    //print('keep breeding $rabbitCount');
    rabbitCount += 4;
  }
  print('$rabbitCount');
  rabbitCount = 19000;
