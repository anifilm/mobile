    ...
    <v-row class="my-3">
      <v-col cols="12">
        <v-card class="py-3 px-3">
          ...
          <v-img height="330px" v-bind:src="this.itemPic.url"></v-img>
      ...
      <v-col cols="12" class="mt-3 text-center">
        <!-- 현재 사진을 삭제하는 버튼 처리 -->
        <v-btn color="pink" fab dark v-on:click="fnDeleteItem()">
...
export default {
  ...
  created() {
    ...
    // find 검색 기능으로 파이어베이에서 해당 ID 항목 검색 및 저장
    this.itemPic = this.oPictures.find((item) => {
